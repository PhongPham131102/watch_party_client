        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <div className="absolute -left-3 -top-2 z-20 animate-tilt-shake pointer-events-none">
              <Sparkles size={20} className="text-amber-300 fill-amber-300 drop-shadow-[0_0_8px_rgba(252,211,77,0.8)]" />
            </div>
            ...
            <Link
              ...
              <span className="relative z-10 tracking-tight">Tham gia Rạp Chung</span>
